...
* **Application**: Orquestração de serviços de suporte e integração como ALB/NLB, SNS, SQS, API GATEWAY.
...
* **Storage**: Armazenamento de objetos com S3, incluindo configurações de CORS e Static Website.
